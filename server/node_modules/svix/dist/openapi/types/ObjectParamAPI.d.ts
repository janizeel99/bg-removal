...
export declare class ObjectEnvironmentApi {
    ...
    v1EnvironmentExportGetWithHttpInfo(param?: EnvironmentApiV1EnvironmentExportGetRequest, options?: Configuration): Promise<HttpInfo<EnvironmentOut>>;
...
export declare class ObjectSinkApi {
    ...
    v1StreamCreateEventsWithHttpInfo(param: SinkApiV1StreamCreateEventsRequest, options?: Configuration): Promise<HttpInfo<any>>;
    v1StreamCreateEvents(param: SinkApiV1StreamCreateEventsRequest, options?: Configuration): Promise<any>;
    v1StreamEventsGetWithHttpInfo(param: SinkApiV1StreamEventsGetRequest, options?: Configuration): Promise<HttpInfo<EventStreamOut>>;
