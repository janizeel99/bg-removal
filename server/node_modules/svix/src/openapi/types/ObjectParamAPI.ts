...
export class ObjectSinkApi {
     ...
     * @param param the request object
     */
    public v1StreamCreateEventsWithHttpInfo(param: SinkApiV1StreamCreateEventsRequest, options?: Configuration): Promise<HttpInfo<any>> {
     ...
     * @param param the request object
     */
    public v1StreamEventsGetWithHttpInfo(param: SinkApiV1StreamEventsGetRequest, options?: Configuration): Promise<HttpInfo<EventStreamOut>> {
